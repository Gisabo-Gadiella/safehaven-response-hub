...
import { Eye, EyeOff, Shield, Home, Mail, Lock } from 'lucide-react'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        // Check if user is admin (you can add this logic later)
        navigate('/dashboard')
      }
    } catch (error) {
      toast({
        ...
        <Card className="card-gradient animate-fade-in shadow-xl border-0">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="text-center pt-4 border-t border-gray-100">
              ...
              <Button variant="emergency" size="sm" className="animate-pulse">
                Emergency Access
              </Button>
            </div>
          </CardContent>
